...
MenuServerList::MenuServerList(sf::RenderWindow& win, sf::UdpSocket& sock_udp, bool& n_connected, sf::IpAddress& ip_serv, sf::Uint8& servStatus) :
    ...
    this->buttonManualIp.setFont(*FontManager::getFont("Textures/JetBreins.ttf"));
    ...
    this->infoInput.setFont(*FontManager::getFont("Textures/JetBreins.ttf"));
    ...
    this->textBar.setFont(*FontManager::getFont("Textures/JetBreins.ttf"));
    ...
    this->info.setFont(*FontManager::getFont("Textures/JetBreins.ttf"));
    this->info.setCharacterSize(24);
    this->info.setString("Ip adresses ---------------------------");
    this->info.setPosition(10.f, SECOND_LINE_Y);

    this->info2.setFont(*FontManager::getFont("Textures/JetBreins.ttf"));
